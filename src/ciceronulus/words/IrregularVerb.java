...
public class IrregularVerb {
	...
	private void createPosse(){
		...
		Posse.add(new Word("potuisse", verb, "", posse66));
		...
		Posse.add(new Word("posse", verb, "", posse67));
	}
