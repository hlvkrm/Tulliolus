...
public class GrammarChecker {
    ...
    public GrammarChecker(Context context) {
    ...
    private void Log(String message) {
        Log.d(GrammarChecker.class.getCanonicalName(), message);
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    e.printStackTrace();
                    MainActivity.displayQueryResult(result+ "Exception occurred during Prolog stuff. Check log for error trace.");
                }
                MainActivity.displayQueryResult(result+ "");
            }
        }).start();
    }
}
